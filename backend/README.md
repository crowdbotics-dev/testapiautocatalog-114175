...
## Project Structure
    ...
    ├── testapiautocatalog_114175  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_114175`
...
2. Clone this repo and `cd testapiautocatalog_114175`
